...
O back-end do projeto, que lida com a lógica e o armazenamento dos dados, está disponível neste repositório. Já o front-end, responsável pela interface do usuário, está disponível [aqui](https://github.com/mfernandanll/food-explorer-frontend).
...
```
$ git clone https://github.com/mfernandanll/food-explorer-backend
```
